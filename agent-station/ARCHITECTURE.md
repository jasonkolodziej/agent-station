...
|---|---|---|
| **M0a** | 🔬 **Spike (2 days):** what a *stable-API* extension can observe about another extension's agent session. Test `chatSessionsProvider` in Insiders. | **Kill-or-confirm for the whole reorder (§7.5).** Do this before writing any product code. |
